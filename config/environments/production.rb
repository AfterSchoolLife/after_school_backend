...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "after_school_rails_production"
  ...
  config.active_storage.default_url_options = { host: 'https://after-school-frontend-tio8.vercel.app' }
