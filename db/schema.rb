...
ActiveRecord::Schema[7.1].define(version: 2024_09_07_082123) do
  ...
  create_table "schedules", force: :cascade do |t|
    ...
    t.date "no_class_dates", default: [], array: true
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "role"
    t.string "country"
    t.string "parent_1_relation"
    t.string "parent_2_relation"
  ...
  create_table "waitlists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["schedule_id"], name: "index_waitlists_on_schedule_id"
